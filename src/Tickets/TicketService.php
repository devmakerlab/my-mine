...
class TicketService extends AbstractService
{
    ...
    public function toEntity(array $ticket): TicketEntity
    {
        return new TicketEntity([
            ...
            'tracker_id' => $ticket['tracker']['id'] ?? null,
            'tracker_name' => $ticket['tracker']['name'] ?? null,
            ...
            'created_on' => $this->convertToTz($ticket['created_on'], 'Europe/Paris'), //@TODO make this dynamic
